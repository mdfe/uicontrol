...
define(function(require, exports, module) {
    ...
    return function($) {
        ...
        $.Poshytip = function(elm, options) {
            ...
            var arrowsDerectory = "tip-arrow tip-arrow-top tip-arrow-right tip-arrow-bottom tip-arrow-left";
            if (this.opts.arrowDerectory && this.opts.arrowDerectory == "bottom") {
                arrowsDerectory = "tip-arrow tip-arrow-bottom";
                arrowStyle = "visibility: inherit!important";
            }


            this.$tip = $(['<div class="', this.opts.className + ' ' + this.opts.additionalClassName, '" style="' + style + '">',
                '<div class="tip-inner tip-bg-image"></div>',
                '<div class="' + arrowsDerectory + '" style="' + arrowStyle + '"></div>',
                '</div>'
        ...
        $.Poshytip.prototype = {
            ...
            show: function() {
                ...
                if (this.opts.masked) {
                    this.$tipMasked = $('<div class="poshytipBGlayer"></div>').appendTo(document.body);
                }
            },
            ...
            reset: function() {
                ...
                if (this.opts.arrowDerectory) {
                    if (this.opts.arrowDerectory == "bottom") {
                        this.$arrow[0].className = 'tip-arrow tip-arrow-bottom';
                    }
                } else {
        ...
        $.fn.poshytip.defaults = {
            ...
            side: '',
            additionalClassName: '', // tip 上要添加的 class
            fixed: false, // 是否固定位置
            masked: false
        };
    }($);
