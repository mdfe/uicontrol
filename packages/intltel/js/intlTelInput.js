...
********************/
    ...
    getCleanNumber: function (format) {
      return this.getNumber(format);
    }, // 自己写的 兼容
    ...
    isValidNumber: function () {
      ...
      var allow = /^\+[\d\s]+$/.test(val);
      if (allow && window.intlTelInputUtils) {
        if (this.getNumberType() !== intlTelInputUtils.numberType.MOBILE && this.getNumberType() !== intlTelInputUtils.numberType.FIXED_LINE_OR_MOBILE) {
          return false;
        }
